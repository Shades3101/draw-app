                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative group">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400 group-focus-within:text-[#2c2c2c] dark:group-focus-within:text-zinc-100" />
                            <input
                                type="text"
                                placeholder="Search boards..."
                                value={searchQuery}
                                onChange={(e) => setSearchQuery(e.target.value)}
                                className="pl-10 pr-4 py-2 border-2 border-[#2c2c2c] dark:border-zinc-100 bg-white dark:bg-zinc-900 dark:text-zinc-100 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)] focus:outline-none focus:translate-x-[2px] focus:translate-y-[2px] focus:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:focus:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)] transition-all font-bold uppercase text-xs w-full md:w-64"
                            />
                        </div>

                        <Dialog>
                            <DialogTrigger asChild>
                                <button className="px-6 py-2 bg-blue-500 text-white border-2 border-[#2c2c2c] dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)] transition-all flex items-center gap-2 font-black uppercase italic text-sm">
                                ...
                                <form onSubmit={handleCreateRoom} className="space-y-6 pt-4">
                                    ...
                                    <div className="flex justify-end pt-4">
                                        <button
                                            ...
                                            className="px-8 py-3 bg-[#2c2c2c] dark:bg-zinc-100 text-white dark:text-zinc-900 border-2 border-[#2c2c2c] dark:border-zinc-100 shadow-[4px_4px_0px_0px_rgba(59,130,246,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(59,130,246,1)] transition-all font-black uppercase italic disabled:opacity-50"
                                        >
                                            Launch Editor
                                        </button>
                                    </div>
                ...
                {filteredRooms.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-32 border-4 border-dashed border-[#2c2c2c] dark:border-zinc-100 bg-zinc-50/50 dark:bg-zinc-900/50">
                        ...
                        <button
                            ...
                            className="px-8 py-3 border-2 border-[#2c2c2c] dark:border-zinc-100 bg-white dark:bg-zinc-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)] font-black uppercase italic hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)] transition-all"
                        >
                        ...
                        {filteredRooms.map((room) => (
                            ...
                            >
                                ...
                                <div className="relative border-2 border-[#2c2c2c] dark:border-zinc-100 bg-white dark:bg-zinc-900 h-full flex flex-col transition-transform group-hover:-translate-x-1 group-hover:-translate-y-1">
                                    {/* Card Preview Area */}
                                    <div className={`h-40 ${room.color} dark:opacity-80 border-b-2 border-[#2c2c2c] dark:border-zinc-100 relative overflow-hidden p-4`}>
                                    ...
                                    <div className="p-5 flex-1 flex flex-col">
                                        ...
                                        <div className="mt-auto flex items-center justify-between font-bold text-[10px] uppercase tracking-widest text-zinc-500 dark:text-zinc-400">
                                            <div className="flex items-center gap-1.5">
                                                <Clock className="w-3 h-3" />
                                                {room.lastEdited}
                                            </div>
                                            <div className="flex items-center gap-1.5 px-2 py-0.5 border border-[#2c2c2c] dark:border-zinc-100 bg-zinc-50 dark:bg-zinc-800 rounded-sm">
